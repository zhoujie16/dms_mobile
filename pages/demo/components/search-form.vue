  ...
  <view>
    <view class="form-demo-wrap" @touchmove.prevent>
      ...
      <MLabel v-model="cph" label="弹窗选择 单选" :row="2">
        <button @click="test1" size="mini" type="default" class="submit-btn">{{ val_test1 ?val_test1 : '弹窗选择'}}</button>
      </MLabel>
      <MLabel v-model="cph" label="弹窗选择 多选" :row="2">
        <button @click="test11" size="mini" type="default" class="submit-btn">{{ val_test11 ?val_test11 : '弹窗选择'}}</button>
      </MLabel>
      <MLabel v-model="cph" label="日期选择" :row="2">
        <button @click="test2" size="mini" type="default" class="submit-btn">{{val_test2 ?val_test2 : '日期选择'}}</button>
      </MLabel>
      <view class="btn-v">
