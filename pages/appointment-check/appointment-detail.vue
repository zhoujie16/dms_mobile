...
<template>
  <MPage ref="MPage" type="primary" title="预约检查详情">
    ...
    <view class="page-body">
      ...
      <view class="operate">
        <view class="btn">
          <m-button type="default" @click.native="cancelClick">取消预约</m-button>
        </view>
        <view class="btn">
          <m-button type="primary">外观预检</m-button>
        </view>
      </view>
    </view>
